export const aboutPage = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "We are 100% American Made—engineered, designed, and built entirely in the USA for uncompromising quality. Our modular architecture lets you swap attachments instantly to adapt a single platform to any seasonal task, replacing an entire fleet of expensive, single-use machines with one intelligent system.",
        "A brushless, gearless direct-drive chassis delivers unyielding torque for heavy-duty work, while advanced navigation provides reliable, continuous awareness in unpredictable real-world conditions. Continuous over-the-air software updates ensure every robot gets smarter over time.",
      ],
    },
    {
