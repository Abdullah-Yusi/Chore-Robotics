  ...
  pressReleases: {
    ...
    items: [
      ...
      },
      {
        ...
        summary:
          "The company established its U.S. headquarters at 15 Hubble, Suite 200, Irvine, CA, consolidating engineering, production, and field operations under one roof.",
      },
      {
        id: "pr-004",
        date: "2025-06-04",
